...
from lib.models.ostrack.vit import vit_base_patch16_224, AdaptiveGradReverse, AlphaScheduler, resize_pos_embed
...
class OSTrack(nn.Module):
    ...
    def forward(self, template: torch.Tensor,
        ...
        out['weight_z'] = aux_dict["weight_z"]  # (B, 1)
        out['weight_x'] = aux_dict["weight_x"]  # (B, 1)
...
def build_ostrack(cfg, training=True):
    ...
    if cfg.MODEL.BACKBONE.TYPE == 'vit_base_patch16_224':
        backbone = vit_base_patch16_224(pretrained,
                                        ...
                                        grl_index=cfg.MODEL.BACKBONE.GRL_INDEX)
    ...
    alpha_scheduler = AlphaScheduler(mode=cfg.TRAIN.ALPHA.DECAY_MODE,
                                     initial_alpha=cfg.TRAIN.ALPHA.DECAY_INIT,
                                     decay_epoch=cfg.TRAIN.ALPHA.DECAY_EPOCH,
                                     decay_rate=cfg.TRAIN.ALPHA.DECAY_RATE
                                     )
    grad_reverse = AdaptiveGradReverse(alpha_scheduler)
