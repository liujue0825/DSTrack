...
class TrackingSampler(torch.utils.data.Dataset):
    ...
    def getitem(self):
        ...
        while not valid:
            ...
            try:
                # NOTE: 额外加载模态标签
                template_frames, template_anno, meta_obj_train, label_train = dataset.get_frames(seq_id,
                                                                                                 template_frame_ids,
                                                                                                 seq_info_dict)
                search_frames, search_anno, meta_obj_test, label_train_search = dataset.get_frames(seq_id,
                                                                                                   search_frame_ids,
                                                                                                   seq_info_dict)
