...
if __name__ == '__main__':
    # python tracking/test.py ostrack baseline --dataset comtb --threads 4 --num_gpus 4
    # python tracking/test.py ostrack baseline --dataset comtb --threads 1 --num_gpus 1 --debug 1
    main()
