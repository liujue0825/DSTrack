...
if __name__ == "__main__":
    # CUDA_VISIBLE_DEVICES=0,4,6,7 python tracking/train.py --script ostrack --config baseline --save_dir ./output --mode multiple --nproc_per_node 4
    # CUDA_VISIBLE_DEVICES=0,1,2,3 nohup python tracking/train.py --script ostrack --config baseline --save_dir ./output --mode multiple --nproc_per_node 4
    main()
